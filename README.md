...
[![Tests: 3797](https://img.shields.io/badge/tests-3797-brightgreen)](tests/)
...
lockfile detection -> metadata fetch -> scanner execution -> enrichment
                     ...
                     (53, via pip registry)    (33, filesystem-based)
                              |                       |
...
3. **Scanner execution** — 53 entry-point scanners + 33 project scanners run concurrently.
...
53 entry-point scanners + 33 project scanners. 57 scanner files total — many serve both roles.
...
depfence/          ~46K LOC
  ...
  scanners/        57 scanner modules (53 entry-point, 33 project)
